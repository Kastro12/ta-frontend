...
import { localCulturePeopleLandscapes } from '@/data/organizedVacations';
...
export default function BookVacation() {
  ...
  localCulturePeopleLandscapes.dailyOgranization.forEach((item) => {
  ...
  useEffect(() => {
    dispatch(addPredefinedVacation(localCulturePeopleLandscapes.title));
  }, []);
  ...
  return (
    <Container maxWidth='lg' className='custom-container' sx={{ mt: 3 }}>
      ...
      >
        {localCulturePeopleLandscapes.description}
      </Typography>
      ...
      <div className='vacation-summary'>
        ...
        <div className='box'>
          ...
          <Typography variant='body1'>
            {localCulturePeopleLandscapes.dailyOgranization.length} days, you choose started day
          </Typography>
        </div>
      ...
      <div className='form-background in-container calendar-persons'>
        <div className='form-calendar-persons'>
          <CalendarFormWithHandleCalendarDate
            duration={localCulturePeopleLandscapes.dailyOgranization.length}
          />
