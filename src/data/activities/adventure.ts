...
const rafting: Activity[] = [
  {
    ...
    translationKey: 'rafting_on_the_tara_river',
  ...
  },
  {
    ...
    translationKey: 'rafting_on_the_ibar_river',
...
const paragliding: Activity[] = [
  {
    ...
    translationKey: 'paragliding_zlatibor',
  ...
  },
  {
    ...
    translationKey: 'paragliding_budva',
...
const kayaking: Activity[] = [
  ...
  },
  {
    ...
    translationKey: 'kayaking_danube_iron_gate',
  ...
  },
  {
    paidAd: false,
    id: 'war_island_kayak',
    translationKey: 'war_island_kayak',
...
const jeep_safary: Activity[] = [
  {
    ...
    translationKey: 'jeep_safari_durmitor_rings',
...
const horse_riding: Activity[] = [
  {
    ...
    translationKey: 'horse_riding_tara',
  ...
  },
  {
    ...
    translationKey: 'horse_riding_fruska_gora',
...
const hiking: Activity[] = [
  {
    ...
    translationKey: 'hiking_rtanj_mountain',
...
const fishing: Activity[] = [
  {
    ...
    translationKey: 'fishing_on_the_drina_river',
  ...
  },
  {
    ...
    translationKey: 'fishing_on_the_tara_river',
...
const cycling: Activity[] = [
  {
    paidAd: false,
    id: 'cycling_kopaonik',
    translationKey: 'cycling_kopaonik',
...
const canyoning: Activity[] = [
  {
    ...
    translationKey: 'canyoning_nevidio',
...
const bungee_jump: Activity[] = [
  {
    ...
    translationKey: 'bungee_jump_ada_ciganlija',
...
const quad_bike: Activity[] = [
  {
    ...
    translationKey: 'quad_bike_zlatibor',
